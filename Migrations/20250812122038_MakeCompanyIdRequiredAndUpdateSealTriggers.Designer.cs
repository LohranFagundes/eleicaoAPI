...
namespace ElectionApi.Net.Migrations
{
    ...
    [Migration("20250812122038_MakeCompanyIdRequiredAndUpdateSealTriggers")]
    partial class MakeCompanyIdRequiredAndUpdateSealTriggers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElectionApi.Net.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ElectionApi.Net.Models.Election", b =>
                {
                    b.HasOne("ElectionApi.Net.Models.Company", "Company")
                        .WithMany("Elections")
